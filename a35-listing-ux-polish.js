 ...
 * Visual-only. Keep the existing detail structure; remove excessive mobile spacing/sticky behavior.
 */
(()=>{
...
.a359Section{position:relative;padding:14px!important;margin-top:10px!important;border-radius:16px!important}
.a359Section>h3{font-size:17px!important;margin:0 0 9px!important}
.a359Grid{gap:0 16px!important}
.a359Field{padding:9px 0!important}
.a359DetailActions{position:static!important;padding:0!important;margin:10px 0 0!important;border:0!important;border-radius:0!important;background:transparent!important;backdrop-filter:none!important}
.a359DetailActions button{min-height:42px!important;font-weight:800}
.a3513Lead{font-size:12px;opacity:.72;margin:0 0 8px}
.a3513Badge{display:inline-flex;align-items:center;gap:6px;padding:5px 9px;border-radius:999px;font-size:12px;font-weight:800;margin-top:7px}
.a3511Dots{margin:5px 0 4px!important}
@media(max-width:600px){.a359Section{padding:13px!important;margin-top:8px!important}.a359HeroCover,.a3511Carousel{border-radius:16px!important}.a3511Slide{aspect-ratio:4/3}.a359HeroTitle{font-size:22px;margin-top:9px}.a359HeroPrice{margin-top:5px!important}.a359DetailActions{margin-top:8px!important}.a359DetailActions button{flex:1}}
